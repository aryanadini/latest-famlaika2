...
import '../addmember/MemberProvider.dart';



class EditAddmember extends StatefulWidget {
...
// final List<Map<String, dynamic>> familyTreeData;

  //inal bool isSibling;
  final bool isGenderFixed;
  EditAddmember({super.key, this.relation,  this.defaultMale,
    this.isGenderFixed = false,
     this.gender,this.profilePic,this.name,
    this.mobile,this.dateOfBirth,this.relationValue,
    //required this.familyTreeData, required this.memberIndex,

    //required this.familyTreeData,
    //required this.isSibling,
  });


  @override
  State<EditAddmember> createState() => _EditAddmemberState();
}

class _EditAddmemberState extends State<EditAddmember> {
  List<Map<String, dynamic>> familyTreeData = [];
  File? _image;
  ...
  void initState() {
    ...
    print('Initializing EditMember with1:');
  ...
  //... // female = !widget.defaultMale;
   ...
   //....// _RelationController.text = widget.relation;
    ...
    // final member = widget.familyTreeData[widget.memberIndex];
    // _FullNameController= TextEditingController(text: member['name'] ?? '');
    // _RelationController=TextEditingController(
    //   text: widget.familyTreeData.isNotEmpty ? widget.familyTreeData[0]['name'] : '',
    // );
  ...
  void dispose() {
    _FullNameController.dispose(); // Dispose the controller
    super.dispose();
  }
                          ...
                          child: Column(
                            children: [
                                ...
                                children: [
                                  ...
                                  child:  InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          border: Border.all(color: female
                                              ? Colors.amber
                                              : Colors.grey.shade800),
                                          borderRadius: BorderRadius.circular(
                                              5.r),

                                          color: female ? Colors.amber
                                              .withOpacity(0.1) : Colors.black
                                              .withOpacity(0.1),
                                        ),
                                        child: Row(
                                          children: [
                              ...
                              SizedBox(
                                ...
                                width: 300.w,
                                child: TextFormField(
                                 // initialValue: familyTreeData.isNotEmpty ? familyTreeData[0]['name'] : '',
